...
print "%d passengers" % number_passengers
print "%d number survived" % number_survived
print "%s proportion_survivors" % proportion_survivors
...
prediction_file = open("submissions/genderbasedmodel.csv", "wb")
...
predictions_file = open("submissions/better-genderbasedmodel.csv", "wb")
